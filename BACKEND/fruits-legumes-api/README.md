...
```
with `<OCP APPLICATIONS DOMAIN>`: OCP applications domain. E.g.: `apps.cluster-lctdv.lctdv.sandbox276.opentlc.com`
...
6. **OPTIONAL** - In order to test the service directly (without going through the _APICast gateway_), create a _passthrough_ OpenShift route:
    ...
    spec:
        host: fruits-legumes-api-direct.apps.cluster-lctdv.lctdv.sandbox276.opentlc.com
        port:
            targetPort: https
        tls:
...
--production-public-base-url='https://fruits-legumes-api.apps.cluster-lctdv.lctdv.sandbox276.opentlc.com' \
--staging-public-base-url='https://fruits-legumes-api-staging.apps.cluster-lctdv.lctdv.sandbox276.opentlc.com' \
--oidc-issuer-type=keycloak \
--oidc-issuer-endpoint='https://rhpds-3scale-apim-demo-zync:FePg0fXDCqpm0EptPesoROh93AT9CwQB@sso.apps.cluster-lctdv.lctdv.sandbox276.opentlc.com/auth/realms/openshift-cluster' \
